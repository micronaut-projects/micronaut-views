...
class InputTelViewRenderTest {
    ...
    void render(ViewsRenderer<Map<String, Object>, ?> viewsRenderer,
        ...
        assertEquals("""
        <div class="mb-3"><label for="phone" class="form-label">Phone</label><input type="tel" name="phone" value="123567" id="phone" class="form-control" required="required"/></div>""", TestUtils.render("fieldset/fieldset.html", viewsRenderer, Map.of("el", fieldset)));
        ...
        assertEquals("""
        <div class="mb-3"><label for="phone" class="form-label">Phone</label><input type="tel" name="phone" value="" id="phone" class="form-control is-invalid" aria-describedby="phoneValidationServerFeedback" required="required"/><div id="phoneValidationServerFeedback" class="invalid-feedback">must not be blank</div></div>""", TestUtils.render("fieldset/fieldset.html", viewsRenderer, Map.of("el", fieldset)));
    }
