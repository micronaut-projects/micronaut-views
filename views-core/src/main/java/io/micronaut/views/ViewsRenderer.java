 ...
 *
 * @see ReactiveViewRenderer for reactive-style view rendering
...
public interface ViewsRenderer extends BaseViewsRenderer {
     ...
     * @return A writable where the view will be written to.
     */
    default @Nonnull Writable render(@Nonnull String viewName, @Nullable Object data, @Nonnull HttpRequest<?> request) {
