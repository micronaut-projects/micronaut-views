...
public record InputEmailFormElement(@NonNull String name,
     ...
     * Input Email builder.
     */
    public static final class Builder extends InputStringFormBuilder<InputEmailFormElement, Builder> {

        /**
         *
         * @return Instantiate a {@link InputEmailFormElement}
         */
        @NonNull
        public InputEmailFormElement build() {
            return new InputEmailFormElement(name, id, placeholder, required, readOnly, maxLength, minLength, pattern, size, value, label, errors == null ? Collections.emptyList() : errors);
        }
    }
}
