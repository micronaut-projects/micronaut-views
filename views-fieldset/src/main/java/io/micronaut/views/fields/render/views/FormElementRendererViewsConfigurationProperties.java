...
/**
 * {@link io.micronaut.context.annotation.DefaultImplementation} of {@link FormElementRendererViewsConfiguration} based on a {@link ConfigurationProperties} instance.
 *
 * @author Sergio del Amo
 * @since 4.1.0
 */
@Internal
@ConfigurationProperties(FormElementRendererViewsConfigurationProperties.PREFIX)
public class FormElementRendererViewsConfigurationProperties implements FormElementRendererViewsConfiguration {

    /**
     * The prefix for form element rendering with views.
     */
