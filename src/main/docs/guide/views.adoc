...
snippet::io.micronaut.views.docs.views.ViewsController[tags="clazz,map,endclass"]
...
snippet::io.micronaut.views.docs.views.ViewsController[tags="clazz,pojo,endclass"]
...
snippet::io.micronaut.views.docs.views.ViewsController[tags="clazz,modelAndView,endclass"]
