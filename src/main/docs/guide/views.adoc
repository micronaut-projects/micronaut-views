...
Use the https://micronaut-projects.github.io/micronaut-core/latest/api/io/micronaut/core/annotation/Introspected.html[@Introspected] annotation on your POJO object to avoid reflection at runtime (It will also fix a problem with OpenJ9 jvm.)
...
You can also provide implementations of api:views.model.ViewModelProcessor[] to decorate the model with
extra properties.
