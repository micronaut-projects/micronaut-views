...
NOTE: Models need to be Introspected objects with properties, or Maps. Passing a Collection or List as a model is not supported. If you need a List in your model, wrap it in a Map or POJO.
