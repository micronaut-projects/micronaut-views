...
----
include::{testsviewsVelocity}/groovy/io/micronaut/views/model/security/BooksController.java[tags=class]
----
...
----
include::{testsviewsVelocity}/resources/views/securitydecorator.vm[tag=html]
----
