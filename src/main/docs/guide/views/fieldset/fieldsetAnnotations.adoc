...
You will create a representation for the form submission and annotate the `password` field with ann:views.fields.annotations.InputPassword[]. Something like:

snippet::io.micronaut.views.docs.fieldset.Login[]
