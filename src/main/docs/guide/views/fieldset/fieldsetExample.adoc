...
<form action="/books/save" method="post">
    ...
    <div class="mb-3">
        ...
        <input type="number" name="pages" value="" id="pages" class="form-control" required="required"/>
    </div>
...
Thanks to the form generation API, you could create a controller such as:
...
https://micronaut.io/launch?features=views-thymeleaf[Micronaut Launch] or the Micronaut Command Line Interface (CLI) generate Thymeleaf fragments to render a form when you select the `views-thymeleaf` feature.
