Turbo fetch request includes an HTTP Header `Turbo-Frame`, and you click a link within a Turbo Frame.
...
You can render a https://turbo.hotwired.dev/reference/streams[Turbo Frame] easily by annotating a controller route with
