# TODO(python): exercises AuthorFetcher/BookAuthorSave, whose Python ports cannot be compiled (same-arity overloads of
# OptionFetcher.generate).
...
#         assert java.instanceof(book_id, InputHiddenFormElement)
#         assert book_id.name() == "bookId"
#         author_id = fields.get(1)
#         assert java.instanceof(author_id, SelectFormElement)
