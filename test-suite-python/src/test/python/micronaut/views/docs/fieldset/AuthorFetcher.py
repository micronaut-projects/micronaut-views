# TODO(python): a Python class cannot implement io.micronaut.views.fields.fetchers.OptionFetcher because its
# abstract methods generate(Class<T>) and generate(T) are same-arity overloads and Python has no method overloading.
