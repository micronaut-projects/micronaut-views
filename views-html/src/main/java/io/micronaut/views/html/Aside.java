...
@Introspected
public class Aside extends AbstractHtmlElement {
    private static final String TAG = "aside";

    protected Aside(@NonNull Map<@NonNull String, @NonNull String> attributes,
    ...
    public static class Builder extends HtmlElementBuilder<Builder> {
        public Aside build() {
            return new Aside(attributes, content, elements);
        }
    }
}
