...
@Introspected
public class Footer extends AbstractHtmlElement {
    private static final String TAG = "footer";

    protected Footer(@NonNull Map<@NonNull String, @NonNull String> attributes,
    ...
    public static class Builder extends HtmlElementBuilder<Builder> {
        public Footer build() {
            return new Footer(attributes, content, elements);
        }
    }
}
