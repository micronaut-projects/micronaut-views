...
@Introspected
public class TableHead extends AbstractHtmlElement {
    private static final String TAG = "thead";

    public TableHead(@NonNull Map<@NonNull String, @NonNull String> attributes,
    ...
    public static class Builder extends HtmlElementBuilder<Builder> {
        ...
        public @NonNull TableHead build() {
            return new TableHead(attributes, content, rows);
        }
    }
}
