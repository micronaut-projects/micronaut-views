...
@Introspected
public class Blockquote extends AbstractHtmlElement {
    private static final String TAG = "blockquote";

    protected Blockquote(@NonNull Map<@NonNull String, @NonNull String> attributes,
    ...
    public static class Builder extends HtmlElementBuilder<Builder> {
        public Blockquote build() {
            return new Blockquote(attributes, content, elements);
        }
    }
}
